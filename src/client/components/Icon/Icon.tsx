...
export function IconButton({
  ...
  return (
    <button className={buttonClass} onClick={onClick} disabled={disabled} title={title} {...props}>
...
export function IconToggle({ activeIcon, inactiveIcon, isActive, ...props }: IconToggleProps) {
  return (
    <IconButton
