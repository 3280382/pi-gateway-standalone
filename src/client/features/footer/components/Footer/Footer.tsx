/**
 * Footer - Application footer with navigation controls
 */
	...
	return (
		<nav className={styles.footer}>
			<div className={styles.leftGroup}>
				...
				{onToggleBottomPanel && (
					<button
						className={`${styles.menuButton} ${isBottomPanelOpen ? styles.active : ""}`}
						onClick={onToggleBottomPanel}
						title={
							isBottomPanelOpen ? "Hide Bottom Panel" : "Show Bottom Panel"
						}
					>
