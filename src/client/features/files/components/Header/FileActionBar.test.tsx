...
describe("FileActionBar", () => {
  ...
  it("renders nothing when no file is selected", () => {
    ...
    const { container } = render(
      <FileActionBar onExecute={mockOnExecute} onOpenBottomPanel={mockOnOpenBottomPanel} />
    );
  ...
  it("renders selected file name", () => {
    render(<FileActionBar onExecute={mockOnExecute} onOpenBottomPanel={mockOnOpenBottomPanel} />);
  ...
  it("calls openViewer with view mode when View button is clicked", () => {
    ...
    expect(mockOpenViewer).toHaveBeenCalledWith("/test/file.js", "file.js", "view");
  });
  ...
  it("calls openViewer with edit mode when Edit button is clicked", () => {
    ...
    expect(mockOpenViewer).toHaveBeenCalledWith("/test/file.js", "file.js", "edit");
  });
  ...
  it("executes file and calls callbacks when Run button is clicked", async () => {
    ...
    await waitFor(() => {
      expect(executeFile).toHaveBeenCalledWith("/test/file.js", expect.any(Function));
