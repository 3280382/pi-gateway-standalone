...
echo "窗格布局（上1/3、下2/3）:"
echo -e "${BLUE}┌───────────────────────┬───────────────────────┐${NC}"
echo -e "${BLUE}│  ${GREEN}🎨 前端窗格 (0)${BLUE}      │  ${GREEN}🖥️  后端窗格 (1)${BLUE}      │${NC}  上部33%"
...
echo "  关闭终端       强制关闭所有"
echo ""
echo "恢复会话: tmux attach -t gateway-dev"
echo "杀掉会话: tmux kill-session -t gateway-dev"
echo ""
